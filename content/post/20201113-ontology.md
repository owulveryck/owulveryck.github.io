...
_entity1_ has the _property_ _entity2 .
...
- this _element that has a perfomer (http://www.wikidata.org/prop/direct/P175) who is Peter Gabriel (http://www.wikidata.org/entity/Q175195).
- this _element that has a producer (http://www.wikidata.org/prop/direct/P162) who is Daniel Lanois (http://www.wikidata.org/entity/Q935369).
...
And we add some sytanctic sugar to do a proper query in SPARQL:
{{<highlight sparql>}}
...
_Note_: SPARQL is out-of-scope of this article, to learn more, please cf https://www.wikidata.org/wiki/Wikidata:SPARQL_tutorial
