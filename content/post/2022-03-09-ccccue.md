...
draft: false
summary: "Thanks to the CUE language, this article will expose a way to draw diagrams as data. It introduces a CUE module holding the definitions for C4 components declarations."
---
...
![C4 model box showing a system element with label and description](/assets/images/2022-03-10-11-09-20.png)
...
A complete example is hosted [in the cue4puml4c4 repository](https://github.com/owulveryck/cue4puml4c4/blob/9b428e390ba93330a9955e48ce2e48bd6f64fd57/example/example1.cue). It generates this picture (which is meaning-less :):

![C4 architecture diagram with App Engine, Twitter, database, and Kafka](/assets/images/2022-03-13-18-47-31.png)
...
the source code is [in the cmd directory on GitHub](https://github.com/owulveryck/cue4puml4c4/tree/main/cmd)

![Animated demonstration of CUE configuration language validation](/assets/images/anim2.webp)
